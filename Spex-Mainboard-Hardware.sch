...
U 1 1 5657DEDB
P 5150 4850
F 0 "#PWR04" H 5150 4600 50  0001 C CNN
...
U 1 1 5657ECC4
P 1350 1400
F 0 "#PWR06" H 1350 1150 50  0001 C CNN
...
U 1 1 5679E0BF
P 4750 4650
F 0 "C7" H 4775 4750 50  0000 L CNN
F 1 "C" H 4775 4550 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 4788 4500 30  0001 C CNN
...
U 1 1 5679E124
P 5500 4650
F 0 "C8" H 5525 4750 50  0000 L CNN
F 1 "C" H 5525 4550 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 5538 4500 30  0001 C CNN
...
U 1 1 56DC2093
P 1950 2600
F 0 "#PWR013" H 1950 2350 50  0001 C CNN
...
U 1 1 56DE9648
P 9550 1650
F 0 "#PWR014" H 9550 1400 50  0001 C CNN
...
U 1 1 56DE991B
P 9550 1100
F 0 "#PWR015" H 9550 850 50  0001 C CNN
...
U 1 1 56DE9D94
P 10900 1450
F 0 "#PWR016" H 10900 1300 50  0001 C CNN
...
$EndSheet
$Sheet
S 9700 3950 1400 1000
U 56DF75A2
F0 "Power Distribution" 60
F1 "SpexPowerBoard.sch" 60
F2 "VBus" I L 9700 4000 60 
F3 "VBat" I L 9700 4100 60 
F4 "Bat1-2" I L 9700 4200 60 
F5 "Bat2-3" I L 9700 4300 60 
F6 "BatGnd" I L 9700 4400 60 
F7 "PowSDA" I L 9700 4500 60 
F8 "PowSCL" I L 9700 4600 60 
F9 "PowIRQ" I L 9700 4700 60 
F10 "3v3Out" I L 9700 4800 60 
F11 "3v3Gnd" I L 9700 4900 60 
$EndSheet
$Comp
L +3.3V #PWR019
U 1 1 56DF91D1
...
F 1 "+3.3V" H 8950 4940 50  0000 C CNN
...
U 1 1 56DF99D4
P 8950 4900
F 0 "#PWR020" H 8950 4650 50  0001 C CNN
...
U 1 1 56E8E64F
P 9050 6050
F 0 "#PWR022" H 9050 5800 50  0001 C CNN
...
U 1 1 56EACCC0
P 11050 2400
F 0 "#PWR023" H 11050 2150 50  0001 C CNN
...
Data Bus Protection\n
$Sheet
S 550  5050 1950 2650
U 56EB0DA0
F0 "Data_Input_Output" 60
F1 "Data_Input_Output.sch" 60
F2 "Data_3.3V" I R 2500 6000 60 
F3 "Data_GND" I R 2500 6100 60 
F4 "TX_RS485" I R 2500 6250 60 
F5 "RX_RS485" I R 2500 6350 60 
F6 "TX/RX_Ctrl" I R 2500 6450 60 
F7 "RX_CAN" I R 2500 6600 60 
F8 "TX_CAN" I R 2500 6700 60 
F9 "CANH_out" I L 550 6700 60 
F10 "CANL_out" I L 550 6800 60 
F11 "RS485_B" I L 550 6900 60 
F12 "RS485_A" I L 550 7000 60 
F13 "3.3V_MOS" I R 2500 6850 60 
F14 "5V_MOS" I R 2500 6950 60 
F15 "Vbus_MOS" I R 2500 7050 60 
F16 "3.3V_MOS_OUT" I L 550 6550 60 
F17 "5V_MOS_OUT" I L 550 6450 60 
F18 "Vbus_MOS_OUT" I L 550 6350 60 
F19 "SD_CS" I R 2500 5850 60 
F20 "SD_MOSI" I R 2500 5550 60 
F21 "SD_SCK" I R 2500 5750 60 
F22 "SD_MISO" I R 2500 5650 60 
F23 "SD_CD" I R 2500 5450 60 
F24 "SD_PWRCTRL" I R 2500 5350 60 
F25 "Relay_1" I R 2500 5100 60 
F26 "Relay_2" I R 2500 5200 60 
F27 "Battery_In" I R 2500 7200 60 
F28 "Battery_Out" I L 550 7150 60 
F29 "User_In" I R 2500 7300 60 
F30 "User_Out" I L 550 7250 60 
$EndSheet
$Comp
L +3.3V #PWR024
U 1 1 56EB7622
...
U 1 1 56ECC254
P 7750 2150
F 0 "#PWR026" H 7750 1900 50  0001 C CNN
...
U 1 1 56F436CA
P 1450 3250
F 0 "#PWR027" H 1450 3100 50  0001 C CNN
...
U 1 1 56F43CED
P 1450 3650
F 0 "#PWR028" H 1450 3400 50  0001 C CNN
...
F 2 "Housings_QFP:LQFP-32_7x7mm_Pitch0.8mm" H 2650 2950 50  0001 C CNN
...
RESET_b
Text HLabel 8000 5600 2    60   Input ~ 0
RESET_b
$Comp
L C C4
U 1 1 5657C7F2
...
SD_CTRL
Text GLabel 2650 5100 2    60   Input ~ 0
Relay1_ctrl
...
U 1 1 56FB6452
P 5150 5800
F 0 "U14" H 5150 6000 50  0000 C CNN
F 1 "AT45DB641E" H 5150 6100 50  0000 C CNN
F 2 "SMD_Packages:SOIC-8-N" H 5300 5600 50  0001 C CNN
F 3 "DOCUMENTATION" H 5150 5500 50  0001 C CNN
	1    5150 5800
	1    0    0    -1  
$EndComp
$Comp
...
F 1 "+3.3V" H 6250 5590 50  0000 C CNN
...
U 1 1 56FB6D46
P 6200 6050
F 0 "#PWR033" H 6200 5800 50  0001 C CNN
...
U 1 1 56FB76C9
P 6550 5750
F 0 "C21" H 6575 5850 50  0000 L CNN
F 1 "C" H 6575 5650 50  0000 L CNN
...
U 1 1 56FB8A18
P 6550 6000
F 0 "#PWR035" H 6550 5750 50  0001 C CNN
